...
// For viewports of minimum width 481px, navigation element to be permanently visible, starting styles for navigation text defined. This is to ensure correct styling when changing from portrait to landscape orientation on a mobile device.
...
// For viewports of max width 480px, navigation element to be hidden, menu icon to be visible, starting styles for navigation text defined. This is to ensure correct styling when changing from landscape to portrait orientation on a mobile device.
